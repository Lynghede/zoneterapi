...
// };
    ...
    <ThemeProvider theme={theme}>
        ...
        <Label>Navn</Label>
          ...
          <Label>E-mail</Label>
          <Input type="email" name="Email" placeholder="lars@gmail.dk" required/>
          <Label>Besked/Spørgsmål</Label>
          <TextArea type="text" name="Besked" placeholder="Jeg vil gerne vide mere om din praksis .. " required/>
          {status === "SUCCESS" ? <p>Thanks!</p> : <LargerButton>Submit</LargerButton>}
